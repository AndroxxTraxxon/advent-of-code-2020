...
passports = list()
passport = {'valid': True, 'invalid_fields':[], 'missing':[]}
for line in data:
    if len(line) == 0:
        for field in required_fields:
            if field not in passport:
                passport['valid'] = False
                passport['missing'].append(field)
        ...
        for pair in pairs:
            ...
            if key == 'byr':
                if len(value) == 4:
                    if int(value) in range(1920, 2002 + 1):
                        pass
                    else:
                        passport['valid'] = False
                        passport['invalid_fields'].append(key)
                else:
                    passport['valid'] = False
                    passport['invalid_fields'].append(key)
            elif key == 'iyr':
                if len(value) == 4:
                    if int(value) in range(2010, 2020 + 1):
                        pass
                    else:
                        passport['valid'] = False
                        passport['invalid_fields'].append(key)
                ...
                if len(value) == 4:
                    if int(value) in range(2020, 2030 + 1):
                        pass
                    else:
                        passport['valid'] = False
                        passport['invalid_fields'].append(key)
                ...
                if value.endswith('cm'):
                    if int(value[:-2]) in range(150, 193 + 1):
                        pass
                    else:
                        passport['valid'] = False
                        passport['invalid_fields'].append(key)
                elif value.endswith('in'):
                    if int(value[:-2]) in range(59, 76 + 1):
                        pass
                    else:
                        passport['valid'] = False
                        passport['invalid_fields'].append(key)
...
for field in required_fields:
    if field not in passport:
        passport['valid'] = False
passports.append(passport)
valid_passports = list(filter(lambda a: a.get('valid'), passports))
